...
if __name__ == "__main__":
    ...
    model.add(Dropout(0.4))
    model.add(Bidirectional(LSTM(96, activation = 'tanh', return_sequences = False)))
    model.add(Dropout(0.4))
    ...
    model.fit(trainX, trainY, batch_size = 480, epochs = 10, validation_split = 0.2, callbacks = [ReduceLR])
