...
from keras.layers import Conv2D, MaxPooling2D, ReLU, LeakyReLU, BatchNormalization
...
if __name__ == "__main__":
    ...
    model.add(Dense(4096, kernel_regularizer = l2(5e-4)))
    #  model.add(BatchNormalization())
    model.add(ReLU())
    ...
    model.add(Dense(1024, kernel_regularizer = l2(5e-4)))
    #  model.add(BatchNormalization())
    model.add(ReLU())
    model.add(Dropout(0.5))
